...
void init_ledui_pins(void)
{
        ...
        conf_pin(LEDUI1_PIN, LEDUI1_PORT, PIN_FUNC_OUTPUT_LOW, PIN_FEAT_END);
#else
	conf_pin(LEDUI1_PIN, LEDUI1_PORT, PIN_FUNC_OUTPUT_HIGH, PIN_FEAT_END);
#endif
#if LEDUI_ANODE_ON_IO_PIN == 1
        conf_pin(LEDUI2_PIN, LEDUI2_PORT, PIN_FUNC_OUTPUT_LOW, PIN_FEAT_END);
#else
        conf_pin(LEDUI2_PIN, LEDUI2_PORT, PIN_FUNC_OUTPUT_HIGH, PIN_FEAT_END);
#endif
#if LEDUI_ANODE_ON_IO_PIN == 1
        conf_pin(LEDUI3_PIN, LEDUI3_PORT, PIN_FUNC_OUTPUT_LOW, PIN_FEAT_END);
#else
        conf_pin(LEDUI3_PIN, LEDUI3_PORT, PIN_FUNC_OUTPUT_HIGH, PIN_FEAT_END);
#endif
#if LEDUI_ANODE_ON_IO_PIN == 1
	conf_pin(LEDUI4_PIN, LEDUI4_PORT, PIN_FUNC_OUTPUT_LOW, PIN_FEAT_END);
#else
        conf_pin(LEDUI4_PIN, LEDUI4_PORT, PIN_FUNC_OUTPUT_HIGH, PIN_FEAT_END);
#endif
}
...
static void led_tsk(void *p)
{
		...
		if (sleep_req) {
			...
			l1 = get_pin_out(LEDUI1_PIN, LEDUI1_PORT);
			l2 = get_pin_out(LEDUI2_PIN, LEDUI2_PORT);
			l3 = get_pin_out(LEDUI3_PIN, LEDUI3_PORT);
                        l4 = get_pin_out(LEDUI4_PIN, LEDUI4_PORT);
...
#endif
{
	switch (pos) {
	case LEDUI_BLED1 :
		set_pin_lev(LEDUI1_PIN, LEDUI1_PORT, HIGH);
		break;
	case LEDUI_BLED2 :
		set_pin_lev(LEDUI2_PIN, LEDUI2_PORT, HIGH);
		break;
	case LEDUI_BLED3 :
		set_pin_lev(LEDUI3_PIN, LEDUI3_PORT, HIGH);
		break;
	case LEDUI_BLED4 :
		set_pin_lev(LEDUI4_PIN, LEDUI4_PORT, HIGH);
		break;
	}
}
...
#endif
{
	switch (pos) {
	case LEDUI_BLED1 :
		set_pin_lev(LEDUI1_PIN, LEDUI1_PORT, LOW);
		break;
	case LEDUI_BLED2 :
		set_pin_lev(LEDUI2_PIN, LEDUI2_PORT, LOW);
		break;
	case LEDUI_BLED3 :
		set_pin_lev(LEDUI3_PIN, LEDUI3_PORT, LOW);
		break;
	case LEDUI_BLED4 :
		set_pin_lev(LEDUI4_PIN, LEDUI4_PORT, LOW);
		break;
	}
}
